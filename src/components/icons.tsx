/**
 * Небольшой набор иконок. Все одного веса и размера, рисуются currentColor —
 * иконка обязана помогать узнавать раздел, а не украшать: разнобой стилей
 * читается как случайность и мешает больше, чем помогает.
 */
...
const PATHS: Record<string, string> = {
  ...
  board: "M3 3h7v18H3zM14 3h7v11h-7z",
  ...
  // Кошелёк, а не знак доллара: суммы в тенге, чужая валюта сбивает
  money: "M20 12V8H6a2 2 0 0 1 0-4h12v4M4 6v12a2 2 0 0 0 2 2h14v-4M18 12a2 2 0 0 0 0 4h4v-4z",
